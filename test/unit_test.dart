...
void main() {
  group('Service Test', () {
    ...
    test('Get Characters True Request Scenario', () async {
      expect(await service.getCharacters(client: client, offset: 0), isA<HTTPModel<List<CharacterModel>>>());
    });

    test('Get Characters False Request Scenario', () async {
      ...
      // Data will be null
      expect(await service.getCharacters(client: client, offset: 0, limit: 101), isA<HTTPModel<dynamic>>());
    });
  });
}
